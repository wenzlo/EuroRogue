...
public enum Skill
{
    ...
    ICE_SHIELD(               "Ice Shield", IceShield.class,     AnimationsSys.AnimationType.MELEE_ARCANE,      SkillType.REACTION,  School.ICE, new School[]{School.ICE, School.PHY},      new School[]{School.ICE}, null,           StatusEffect.CHILLED,  0, 0, 1, 2, 1),
    ...
    DAGGER_THROW(       "Dagger Throw", DaggerThrow.class,  AnimationsSys.AnimationType.PROJECTILE,   SkillType.ACTION,  School.PHY, new School[]{School.PHY}, new School[]{School.PHY}, WeaponType.DAGGER, null,   0, 4, 0, 0, 0),
    CHILL(     "Chill", Chill.class, AnimationsSys.AnimationType.MELEE_ARCANE,  SkillType.ACTION,  School.ICE, new School[]{School.ICE},      new School[]{School.ICE}, null,              StatusEffect.CHILLED,  0, 0, 0, 0, 2),
    IMMOLATE(                 "Immolate", Immolate.class,      AnimationsSys.AnimationType.MELEE_ARCANE,  SkillType.ACTION,  School.FIR, new School[]{School.FIR},      new School[]{School.FIR}, null,         StatusEffect.CALESCENT,  0, 0, 0, 0, 2),
    ERUPTION(                 "Eruption", Eruption.class,      AnimationsSys.AnimationType.BLAST,  SkillType.ACTION,  School.FIR, new School[]{School.FIR, School.FIR, School.FIR},      new School[]{School.FIR, School.FIR, School.FIR}, null,  StatusEffect.CALESCENT,  0, 0, 0, 2, 3),
    SHATTER(                 "Shatter", Shatter.class,      AnimationsSys.AnimationType.SHATTER,  SkillType.ACTION,  School.ICE, new School[]{School.ICE, School.ICE, School.ICE},      new School[]{School.ICE, School.ICE, School.ICE}, null,  null,  0, 0, 0, 0, 3),
    CONE_OF_COLD(        "Cone Of Cold", ConeOfCold.class,      AnimationsSys.AnimationType.CONE_OF_COLD,  SkillType.ACTION,  School.ICE, new School[]{School.ICE},      new School[]{School.ICE}, null,  null,  0, 0, 0, 2, 2),
    ARCANE_TOUCH(         "Arcane Touch", ArcaneTouch.class,      AnimationsSys.AnimationType.MELEE_ARCANE,  SkillType.ACTION,  School.ARC, new School[]{School.ARC},      new School[]{School.ARC}, null,     null,  0, 0, 0, 0, 2),
